...
public class Program
{
    static async Task Main(string[] args)
    {
        ...
        var maq1 = new Maquina("Modelo 1", "Prensa Industrial", new DateTime(2025, 10, 25));
        var maq2 = new Maquina("Modelo 2", "Linha de Montagem", new DateTime(2025, 05, 12));
        var maq3 = new Maquina("Modelo 3", "Cortador de Precisão", new DateTime(2025, 11, 01));
        ...
        {
            Console.WriteLine("Máquina com modelo 'Modelo 4' não encontrada.");
        }

        Console.WriteLine(" Operando máquinas encontradas ->");
        await opera1.OperarMaquinaAsync(fabrica01, "Modelo 2");

        Console.WriteLine(" Operando máquinas não encontrads ->");
        await opera2.OperarMaquinaAsync(fabrica01, "Modelo 4");
